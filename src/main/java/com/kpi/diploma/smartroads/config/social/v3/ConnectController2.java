...
//        }
//
//        RedirectView redirectView = this.connectionStatusRedirect(providerId, request);
//        logger.info("in hui1");
//        return redirectView;
//    }
//
...
//        }
//
//        logger.info("FINAL REDIRECT PATH path=" + path );
