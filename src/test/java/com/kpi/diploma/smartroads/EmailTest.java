...
//        String imageUrl =  "https://res.cloudinary.com/demo/image/upload/v1375302801/tquyfignx5bxcbsupr6a.jpg";
//        Matcher matcher = Pattern.compile("[^/]*(?=[.][a-zA-Z]+$)").matcher(imageUrl);
//        if(matcher.find()) System.out.println("+++");
//        String id = Pattern.compile("[^/]*(?=[.][a-zA-Z]+$)").matcher(imageUrl).group(1);
