...
public class CompanyController {
    ...
    private ResponseEntity<RegistrationDriverDto> createDriver(
            @RequestBody RegistrationDriverDto driverDto, @AuthenticationPrincipal MongoUserDetails principal) {
    ...
    private ResponseEntity<RegistrationManagerDto> createManager(
            @RequestBody RegistrationManagerDto managerDto, @AuthenticationPrincipal MongoUserDetails principal) {
